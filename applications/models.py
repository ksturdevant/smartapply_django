...
class Application(models.Model):
	...
	equity_low = models.DecimalField(decimal_places=5, max_digits=9, null=True, blank=True)
	equity_high = models.DecimalField(decimal_places=5, max_digits=9, null=True, blank=True)
